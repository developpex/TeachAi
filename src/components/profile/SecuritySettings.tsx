...
import { Shield, Smartphone, AlertTriangle, LogOut } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg shadow-soft border border-sage/10 p-8">
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={index} className="flex items-center justify-between p-4 rounded-lg border border-sage/20">
              <span className="text-primary-dark">{alert}</span>
