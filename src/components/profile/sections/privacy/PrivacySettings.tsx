    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-dark-nav rounded-lg shadow-soft dark:shadow-dark-soft border border-sage/10 dark:border-dark-border p-8">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-primary-dark dark:text-dark-text">Data Collection & Sharing</h3>
            <p className="text-sm text-primary dark:text-dark-text-secondary">Manage how your data is collected and used</p>
          </div>
        </div>

        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-lg border border-sage/20 dark:border-dark-border">
            <div className="flex items-center space-x-3">
              <div className="p-2 bg-mint/10 dark:bg-mint/5 rounded-lg">
                <Globe className="h-5 w-5 text-accent" />
              </div>
              <div>
                <p className="font-medium text-primary-dark dark:text-dark-text">Usage Data Collection</p>
                ...
                <ul className="mt-2 text-sm text-primary/80 dark:text-dark-text-secondary/80 space-y-1">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-11 h-6 bg-sage/30 dark:bg-dark-surface peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-mint/20 dark:peer-focus:ring-mint/10 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-accent"></div>
            </label>
          </div>
          ...
          <div className="flex items-center justify-between p-4 rounded-lg border border-sage/20 dark:border-dark-border">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-primary-dark dark:text-dark-text">Third-Party Data Sharing</p>
                <p className="text-sm text-primary dark:text-dark-text-secondary">
